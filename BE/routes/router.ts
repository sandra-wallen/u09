...
import { authorizeUser, loginUser, registerUser } from "../controllers/user.controller";
import { createSchedule, deleteSchedule, updateSchedule, getAllSchedules, getSchedule } from "../controllers/schedule.controller";
import { getAllCourses, getAllCoursesAccociatedWithSchedule, getCourse, createCourse, updateCourse, deleteCourse } from '../controllers/course.controller';
