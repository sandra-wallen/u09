			...
			<div class="col-12 col-md-6 p-2 pe-5">
				<form class="text-start">
					<div class="row gx-0 gy-4 py-3">
						...
						<div>
							<button type="button" class="btn btn-primary w-50" :disabled="!validation.userInfoFormValid.value" @click="updateUserInfo">
								Save
							</button>
						</div>
					</div>
			...
			<div class="col-12 col-md-6 p-2 pe-5">
				<form class="text-start">
					<div class="row gx-0 gy-4 py-3">
						...
						<div v-show="changePassword" class="col-12">
							<div class="mb-4">
								<input id="hidden-admin-update-password-input" type="text" v-model="adminStore.model.user.email" style="display: none" />
								<label for="admin-update-user-password-input" class="form-label">New password</label>
								<input id="admin-update-user-password-input" type="password" class="form-control" v-model="model.user.password" />
							</div>
							<div class="mb-4">
								<label for="admin-update-user-repeat-password-input" class="form-label">Repeat password</label>
								<input id="admin-update-user-repeat-password-input" type="password" class="form-control" v-model="model.user.repeatPassword" autocomplete="new-password">
							</div>
							<button type="button" class="btn btn-primary w-50" :disabled="!validation.passwordFormValid.value" @click="updatePassword">Save</button>
						</div>
					</div>
				</form>
			</div>
