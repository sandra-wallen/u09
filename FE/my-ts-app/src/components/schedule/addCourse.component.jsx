...
const AddCourse = () => {
  ...
  return (
    <>
      <button type="button" className="btn btn-primary align-self-end m-2" data-bs-toggle="modal" data-bs-target="#addCourseModal" onClick={() => setOpen(true)}>
        add
      </button>
      <FocusTrap open={open}>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h1 className="modal-title fs-5" id="addCourseModal">Add course</h1>
